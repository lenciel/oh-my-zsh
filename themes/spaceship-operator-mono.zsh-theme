#
# Spaceship with support for operator mono ZSH Theme
#
# Author: Sai Kiran Anagani, https://astarpx.com
# License: MIT
# https://github.com/anaganisk/spaceship-operator-mono-zsh-theme
